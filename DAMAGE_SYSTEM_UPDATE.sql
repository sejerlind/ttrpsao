...
-- 1. Create function to calculate damage reduction
...
-- 2. Create function to determine if an attack is magical
...
-- 3. Update the enemy attack function to use armor/magic resist
...
-- 4. Create function to add armor/magic resist values to existing enemies
...
-- 5. Run the function to add resistances to existing enemies
SELECT add_enemy_resistances();

-- 6. Create view for enemy stats with resistances
